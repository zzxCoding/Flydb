...
class FlydbAutoConfigurationTest {
    ...
    void dedicatedUrlIgnoresApplicationDataSourceAndMigrates() {
        String url = h2Url("boot3_dedicated");
    ...
    static class ApplicationDataSourceConfiguration {
        ...
        DataSource dataSource() {
            return new DriverManagerDataSource(h2Url("boot3_application"), "sa", "");
        }

        @Bean
        @DependsOnDatabaseInitialization
        StartupProbe startupProbe(DataSource dataSource) {
            return new StartupProbe(tableExists(h2Url("boot3_application"), "STARTER_PROBE"));
        }
    }
    ...
    static class CustomFlydbConfiguration {
        ...
        DataSource customDataSource() {
            return new DriverManagerDataSource(h2Url("boot3_custom"), "sa", "");
        }
