...
The CLI distribution is generated at `flydb-cli/target/flydb-cli-0.3.5.zip`. The core module enforces an 80% JaCoCo line-coverage gate and zero non-test runtime dependencies via Maven Enforcer.
