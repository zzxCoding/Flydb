...
```bash
curl -LO https://github.com/zzxCoding/Flydb/releases/download/v0.3.1/flydb-cli-0.3.1.zip
unzip flydb-cli-0.3.1.zip
cd flydb-cli-0.3.1
...
The CLI distribution is generated at `flydb-cli/target/flydb-cli-0.3.1.zip`. The core module enforces an 80% JaCoCo line-coverage gate and zero non-test runtime dependencies via Maven Enforcer.
